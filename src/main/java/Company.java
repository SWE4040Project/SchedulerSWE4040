...
public class Company {
    ...
    private void saveNewCompany(String name){
        ...
        try{
            ...
            con = DriverManager.getConnection("jdbc:oracle:thin:@"+DBVar.DATABASE_URL+":"+DBVar.DATABASE_PORT+":"+DBVar.DATABASE_SID,DBVar.DATABASE_USERNAME,DBVar.DATABASE_PASSWORD);
